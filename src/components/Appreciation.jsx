    ...
    return (
        <>
            ...
            <Dialog fullWidth={true} open={open} onClose={handleClose}>
                <DialogTitle className="bg-gray-100">Appreciation</DialogTitle>
                <DialogContent sx={{ mt: 4 }}>
                    ...
                    <div className='flex justify-end mt-6'>
                        ...
                        <button onClick={submitAppreciation} className="bg-[#74c27b] px-4 py-2 mx-2 rounded-lg font-semibold">Send</button>
                    </div>
